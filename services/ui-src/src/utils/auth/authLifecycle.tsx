...
class AuthManager {
  ...
  constructor() {
    ...
    const expiration = localStorage.getItem("mdctpasrr_session_exp");
    const isExpired =
      expiration &&
  ...
  setTimer = () => {
    ...
    localStorage.setItem("mdctpasrr_session_exp", expiration);
  };
}
...
export const refreshCredentials = async () => {
  ...
  return localStorage.getItem("mdctpasrr_session_exp");
};
