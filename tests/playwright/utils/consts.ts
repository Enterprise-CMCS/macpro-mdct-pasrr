...
export const stateAbbreviation = process.env.TEST_STATE || "SC";
export const reportType = process.env.TEST_REPORT_TYPE || "PASRR";
...
export const expectedStateUserHeading =
